  ...
  const products = [
    {
      ...
      detailedContent: {
        ...
        intro:
          "This is the civilized version of solar — connected to the main electricity grid.",
        howItWorks:
        ...
        benefits: [
          "You get net metering — credits for the surplus energy you supply back.",
        ],
        downsides: [
    ...
    },
    {
      ...
      detailedContent: {
        ...
        intro:
          "This is the hermit mode setup — totally independent of the grid.",
        howItWorks:
    ...
    },
    {
      ...
      detailedContent: {
        ...
        intro:
          "Think of this as the best of both worlds — part on-grid, part off-grid.",
        howItWorks:
    ...
    },
    {
      ...
      detailedContent: {
        ...
        intro:
          "The shiny rectangles everyone posts on LinkedIn after getting a subsidy.",
        howItWorks:
    ...
    },
    {
      ...
      detailedContent: {
        ...
        intro:
          "Used mostly in agriculture — because farmers deserve low-cost energy too.",
        howItWorks:
          "Solar panels power a motor that pumps water from wells, rivers, or tanks.",
        keyTypes: [
          "DC Pumps: Directly powered by panels.",
          "AC Pumps: Require an inverter to convert DC to AC.",
        ],
        benefits: [
          "No fuel, no grid power, no headaches — just sunlight and water flow.",
        ],
      },
    },
    {
      ...
      detailedContent: {
        ...
        intro:
          "For people who want to light their gardens or streets without an electric bill.",
        howItWorks:
        ...
        downsides: [
          "Doesn't do much on cloudy days — unless you like dim ambience.",
        ],
      },
    },
  ];
  ...
  return (
    ...
    >
      <div className="absolute inset-0 z-0">
        <Image
          src="/website-images/home-page-image-3.jpg"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20">
        ...
        >
          ...
          <p className="text-lg text-foreground/70 max-w-3xl mx-auto">
            Comprehensive solar solutions tailored to residential, agricultural,
            ...
            return (
              <div key={index}>
                ...
                <Dialog
                  ...
                  onOpenChange={(open) =>
                    setSelectedProduct(open ? index : null)
                  }
                >
                    ...
                    <div className="space-y-6 mt-4">
                      ...
                      <div className="animate-in fade-in-0 slide-in-from-bottom-2 duration-500 delay-400">
                        ...
                        <p className="text-foreground/70 leading-relaxed pl-6">
                          {product.detailedContent.howItWorks}
                        </p>
                      </div>
                      ...
                      {product.detailedContent.whereUsed && (
                        <div className="animate-in fade-in-0 slide-in-from-bottom-2 duration-500 delay-550">
                          <h4 className="font-semibold text-foreground mb-2 flex items-center gap-2">
                            <span className="text-primary">📍</span> Where it's
                            used
                          </h4>
                          <p className="text-foreground/70 leading-relaxed pl-6">
                            {product.detailedContent.whereUsed}
                      ...
                      {product.detailedContent.benefits && (
                        <div className="animate-in fade-in-0 slide-in-from-bottom-2 duration-500 delay-600">
                          ...
                          <ul className="space-y-2 pl-6">
                            {product.detailedContent.benefits.map(
                              (benefit, i) => (
                                <li
                                  key={i}
                                  className="text-foreground/70 leading-relaxed flex gap-2 animate-in fade-in-0 slide-in-from-left-2 duration-500"
                                  style={{
                                    animationDelay: `${650 + i * 50}ms`,
                                  }}
                                >
                                  <span className="text-primary mt-1">•</span>
                                  <span>{benefit}</span>
                      ...
                      {product.detailedContent.downsides && (
                        <div className="animate-in fade-in-0 slide-in-from-bottom-2 duration-500 delay-700">
                          ...
                          <ul className="space-y-2 pl-6">
                            {product.detailedContent.downsides.map(
                              (downside, i) => (
                                <li
                                  key={i}
                                  className="text-foreground/70 leading-relaxed flex gap-2 animate-in fade-in-0 slide-in-from-left-2 duration-500"
